...
const PricingUSA = () => {
  ...
  const [selectedProgram, setSelectedProgram] = useState<string>("High School");
  const [selectedBoard, setSelectedBoard] = useState<string>("Common Core");
  ...
  const handleGetPricing = () => {
    const message = `Hi! I'm interested in 1-to-1 tutoring for ${selectedProgram} - ${selectedSubject} (${selectedBoard} board) with ${selectedLessons} lesson${selectedLessons > 1 ? 's' : ''} per week for ${selectedDuration} months. Can you provide me with pricing details in USD?`;
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <title>1-to-1 Math & Science Tutoring Pricing USA | MathBeam.com - Expert Online Learning</title>
        <meta name="description" content="Get personalized 1-to-1 math and science tutoring from exceptional tutors starting at $40 per hour. Choose your schedule and duration." />
        <meta name="keywords" content="1-to-1 math tutoring USA, personalized science tutoring, online tutoring pricing USD, math tutoring USA, science tutoring USA" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://mathbeam.com/pricing-usa" />
        <meta property="og:title" content="1-to-1 Math & Science Tutoring Pricing USA | MathBeam.com - Expert Online Learning" />
        <meta property="og:description" content="Get personalized 1-to-1 math and science tutoring from exceptional tutors starting at $40 per hour." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://mathbeam.com/pricing-usa" />
      </Helmet>
          ...
          <div className="text-center mb-12">
            <div className="bg-gradient-to-r from-red-500 to-orange-500 text-white px-6 py-4 rounded-lg shadow-lg mx-auto max-w-md mb-6">
              <div className="flex items-center justify-center space-x-3">
                <span className="text-2xl font-bold line-through text-red-200">$40 per hour</span>
          ...
          <Card className="max-w-2xl mx-auto">
            ...
            <CardContent className="space-y-8">
              ...
              >
                ...
                Get Special Price (USD)
              </Button>

              <p className="text-xs text-gray-500 text-center">
                *Final pricing depends on tutor experience and subject complexity. Contact us for personalized quotes in USD.
              </p>
            </CardContent>
          </Card>
